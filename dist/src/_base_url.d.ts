 ...
 */
export declare function getBaseUrl(httpOptions: HttpOptions | undefined, vertexai: boolean | undefined, vertexBaseUrlFromEnv: string | undefined, geminiBaseUrlFromEnv: string | undefined): string | undefined;
